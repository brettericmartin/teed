      ...
      <section ref={useCasesRef} className="py-24 px-4 sm:px-6 lg:px-8 bg-[var(--surface)]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { title: 'Golfers', description: 'Share your bag setup, track club changes, and discover what the pros use', emoji: '⛳', href: '/for/golfers' },
              { title: 'Travelers', description: 'Curate your perfect packing list, share travel essentials, and never forget an item', emoji: '✈️', href: '/for/travelers' },
              { title: 'Content Creators', description: 'Showcase your gear, monetize with affiliate links, and inspire your audience', emoji: '📸', href: '/for/creators' },
              { title: 'Outdoor Enthusiasts', description: 'Organize hiking gear, camping equipment, and share your adventure setups', emoji: '🏔️', href: '/for/outdoors' },
              { title: 'Tech Enthusiasts', description: 'Display your desk setup, tech stack, and daily carry essentials', emoji: '💼', href: '/for/tech' },
              { title: 'Musicians', description: 'Catalog your instruments, pedals, and studio gear for fellow enthusiasts', emoji: '🎸', href: '/for/musicians' }
            ].map((useCase, index) => (
              <Link
                key={index}
                href={useCase.href}
