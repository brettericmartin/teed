...
export default function LinkManagerModal({
  ...
  return (
    <div className="fixed inset-0 bg-[var(--overlay-bg)] flex items-center justify-center p-4 z-50 backdrop-blur-sm modal-backdrop-enter">
      <div className="bg-[var(--modal-bg)] rounded-[var(--radius-xl)] shadow-[var(--shadow-6)] max-w-2xl w-full max-h-[80vh] overflow-hidden flex flex-col border border-[var(--modal-border)] modal-content-enter">
        {/* Header */}
