...
// UPDATED 2024 source videos
const sourceVideos = [
  {
    custom_name: 'The Smartphone Awards 2024',
    brand: 'MKBHD',
    url: 'https://www.youtube.com/watch?v=E76CUtSHMrU',
    notes: 'Dec 2024 - 10th anniversary smartphone awards. Shows his current production setup and filming style.'
  },
  {
    custom_name: 'Inside Apple iPhone Durability Labs',
    brand: 'MKBHD',
    url: 'https://www.youtube.com/watch?v=HOh6d_r63Bw',
    notes: 'May 2024 - Behind the scenes at Apple labs. Features interview with John Ternus.'
  },
  {
    custom_name: 'MKBHD x Ridge Announcement',
    brand: 'Ridge',
    url: 'https://ridge.com/pages/mkbhd-announcement',
    notes: 'Feb 2024 - Official announcement of MKBHD joining Ridge as Chief Creative Partner and Board Member.'
  }
];

// 2024 VERIFIED PRODUCTS
const recentProducts = [
  // Ridge Collab - Oct/Nov 2024
  {
    ...
    notes: 'Co-designed by MKBHD as Ridge\'s Chief Creative Partner. Signature red/black aesthetic. Launched Oct 2024. $225.',
    is_hero: true
  },
  {
...
async function updateMKBHDBag() {
  ...
  const { data: bag, error: bagError } = await supabase
    ...
    .insert({
      ...
      description: "Everything Marques Brownlee uses to create the internet's best tech reviews. 20M+ subscribers, Hollywood-grade production. Updated Dec 2024.",
      is_public: true,
      code: code,
  ...
  // Add 2024 source videos
  console.log('\n📹 Adding 2024 source content...');
  for (const video of sourceVideos) {
    ...
    if (!itemError && item) {
      ...
      console.log('  ✓ ' + video.custom_name + ' (2024)');
    }
  }
  ...
  console.log('\n✅ Bag updated with 2024 sources!');
  console.log('URL: http://localhost:3000/u/teed/' + bag.code);
  console.log('Total items: ' + totalItems);
  console.log('  - 2024 source content: ' + sourceVideos.length);
  console.log('  - 2024 verified products: ' + recentProducts.length);
